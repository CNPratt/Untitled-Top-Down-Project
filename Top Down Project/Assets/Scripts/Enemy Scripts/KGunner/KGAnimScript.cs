...
public class KGAnimScript : MonoBehaviour
{
    public KGPath kgPath;
    ...
    void Start()
    {
        kgPath = gameObject.GetComponent<KGPath>();
    ...
    void FixedUpdate()
    {
        ...
        if(kgPath.isSearching && !thiskCom.isAttacking)
        {
            currentState = runState;
        }

        else if (thiskCom.spriteSwitch)
        {
//            Debug.Log("switch on");
        ...
        else if (!thiskCom.isAttacking && thiskCom.spriteSwitch == false)
        {
