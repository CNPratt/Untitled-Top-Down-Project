...
//    public bool gotHitSwitch;
    ...
    IEnumerator GotHit()
    {
        ...
        koboldRB.AddForce((transform.position - player.transform.position).normalized * 2f, ForceMode2D.Impulse);
    ...
    void Start()
    {
        ...
        kAnimScript = gameObject.GetComponent<OriginalEnAnimScript>();
